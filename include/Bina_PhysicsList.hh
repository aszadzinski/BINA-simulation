...
public:
        Bina_PhysicsList();
        ~Bina_PhysicsList();
        void SetNeutronModel(G4int neutrony)
        {
                neutrons_model=neutrony;
        };
        //    void SetNeutronType(G4int type)              {neutrons_type=type;};
        void SetBroadening(G4int broad)
        {
                broadening=broad;
        };
        void SetFileOutputs(G4int fileOut)
        {
                file_outputs=fileOut;
        };
        int  GetNeutronModel() {
                return neutrons_model;
        };
        ...
        double GetKinematicsMin()
        {
                return kinematics_min;
        };
        double GetKinematicsMax()
        {
                return kinematics_max;
        };
        int  GetFileOutputs()
        {
                return file_outputs;
