...
private:
	...
	inline double P(double EE,double MP){
									return sqrt(EE*EE - MP*MP);
	}                                                                      //P_relatywist. [MeV] (E_relatywist. [MeV] )
	inline double E(double PP,double MP){
									return sqrt(PP*PP + MP*MP);
	}                                                                       //E_relatywist. [MeV] (P_relatywist. [MeV] )

	// transformation from s1 do s
	inline double Z(double xx1,double,double zz1,double alfa) {
									return (zz1*cos(alfa) - xx1*sin(alfa));
	}
	inline double X(double xx1,double,double zz1,double alfa) {
									return (zz1*sin(alfa) + xx1*cos(alfa));
	}
	inline double Y(double,double yy1,double,double ) {
									return yy1;
	}
